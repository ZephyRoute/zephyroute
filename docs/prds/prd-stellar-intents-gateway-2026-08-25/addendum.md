...
- **Significant strategic tension found reading the Integration Track page in full, 2026-09-20, flagged for the founder's judgment, not resolved here.** The track's own "Who This Track Is For" / "Who This Track Is Not For" section states it is for "teams that have applications with **existing traction**" integrating Stellar building blocks into that already-live product, and explicitly routes the opposite case elsewhere: "Teams building net-new applications (including wallets) **without existing traction** → Better fit for Instawards." Zephyroute, as currently scoped, is a net-new application with zero code written and zero users. Read narrowly, this could mean Integration Track is the wrong track for Zephyroute's actual current stage. Read against the Submission Criteria page's own "Product Readiness & Traction" requirement, though, there is a real alternate path: it requires "significant user traction, **or** a clearly validated need identified by a team or individual with relevant experience in the Stellar ecosystem" (an OR, not an AND). Zephyroute's Phase 2 live-route-test evidence plus the depth of planning done this session could plausibly satisfy "clearly validated need," but the "team... with relevant experience in the Stellar ecosystem" half depends entirely on the actual team's real Stellar/crypto credentials, unknown here, the same recurring gap as PRD Open Question 13's team-size question. **Instawards themselves are not a substitute for the $100K-$150K Integration Track ask**: they cap at $15,000 total, require active local Ambassador Chapter engagement (a community-embedded process, not a direct online application), run as 30-day sprints, and are explicitly framed by the Handbook as "often a first step" toward later Build Award eligibility, not a competing path to the same outcome. This is not something to resolve unilaterally; it depends on facts only the founder has (the team's actual Stellar-ecosystem background) and a real strategic choice (apply to Integration Track now on the "validated need" alternative, or build local Ambassador Chapter engagement and consider an Instaward first). Not acted on further in this document set beyond flagging it clearly here and in a new PRD Open Question. **Corroborated a third time, 2026-09-20:** the Quarterly Governance Process page's own track table defines the Integration track's project type as "Applications with existing traction integrating building blocks to support Stellar," the same phrasing pattern as the track page and the Submission Criteria page. This is consistent internal SCF language, not an isolated wording choice on one page, which strengthens rather than changes the tension already flagged above.
...
- **Minimum team size, read directly from the Official Rules for Submissions, 2026-09-20:** "Your Team or Organization must appoint and authorize at least 2 Eligible Individuals to be available during the preparation webinars, actively participate in bootcamp activities, and should you be interested and get selected as one of the finalists, present during the investor demo day." This is a hard eligibility requirement, not a suggestion, and applies regardless of track. Not yet checked against this project's actual team composition, since `scf-interest-form-draft.md`'s Team section is still an unfilled placeholder. An "Eligible Individual" additionally must be 18+, not resident in a sanctioned jurisdiction (Cuba, Iran, North Korea, Russian-controlled Ukraine, or an OFAC-sanctioned region), not on the OFAC SDN list, and not in a jurisdiction where holding cryptocurrency is illegal or requires an unheld license.
...
- **AI-disclosure requirement, checked live 2026-09-20:** the Handbook's Open Track page explicitly requires "full-disclosure on the use of AI-generated and AI-assisted artifacts (docs, code, etc.)" as part of what makes a strong submission. The Integration Track's own page does not repeat this clause, and the general Official Rules for Submissions page (as much of it as the Handbook MCP could retrieve) doesn't contain an explicit AI-disclosure clause either, so this is not confirmed as a formal Integration Track requirement. It is flagged here regardless, not treated as safely inapplicable, because this project's entire planning document set (PRD, architecture, UX spec, epics, this addendum, the threat model) was substantially produced with AI assistance (Claude) working alongside the founder, and the Open Track's own stated norm suggests the panel likely expects similar transparency across tracks even where a given track's page doesn't spell it out. No code has been written yet, so any eventual disclosure should accurately describe AI involvement in planning/documentation, not implementation. Deliberately not drafting specific disclosure wording here: how the team characterizes its own process is the founder's call, not something to write unilaterally. Flagged as a new open item for `scf-interest-form-draft.md` before submission.
